...
export const FRAMES_META: FrameMeta[] = [
  {
    slug: "semporna-bajau",
    order: 1,
    title: { zh: "仙本那 · 海上巴瑶", en: "Semporna · The Bajau" },
    emoji: "🌊",
  ...
  },
  {
    ...
    order: 2,
    title: { zh: "川西 Road Trip · 风景", en: "West Sichuan · Landscape" },
    emoji: "⛰️",
    location: { zh: "中国 · 川西", en: "West Sichuan, China" },
    tags: [
      { zh: "风光", en: "Landscape" },
  ...
  },
  {
    slug: "sichuan-people",
    order: 3,
    title: { zh: "川西 Road Trip · 人", en: "West Sichuan · People" },
    emoji: "🧑‍🤝‍🧑",
    location: { zh: "中国 · 川西", en: "West Sichuan, China" },
    tags: [
      { zh: "人文", en: "People" },
  ...
  },
  {
    slug: "window-views",
    order: 4,
    title: { zh: "车窗视角", en: "Through the Window" },
    emoji: "🚗",
  ...
  },
  {
    slug: "chaozhou",
    order: 5,
    title: { zh: "潮州", en: "Chaozhou" },
    emoji: "🏯",
    location: { zh: "中国 · 广东潮州", en: "Chaozhou, Guangdong" },
    tags: [
      { zh: "古城", en: "Old town" },
      { zh: "人文", en: "People" },
    ],
